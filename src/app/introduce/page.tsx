    ...
    <div className="mt-7 flex items-start justify-around gap-10 pl-10">
      <div className="flex w-full flex-col gap-7 align-baseline">
        ...
        <div className="break-keep leading-6">
          <p>
            요미디자인은 브랜드의 아이덴티티를 디자인과 연결하며, 다양한 분야의 사인물을 제작 및 시공까지 한 번에
            도와드리는 전문적인 기업입니다.
          </p>
          <p>
            고객님의 브랜드를 위해 저희는 전문 디자이너가 디자인하며, 본사 소속 전문 시공팀이 직접 제작하고 시공해
            드립니다.
          </p>
          <p>다양한 경험과 노하우를 바탕으로 현장에 가장 적합한 사인물을 제안 드릴 것을 약속드립니다.</p>
        </div>

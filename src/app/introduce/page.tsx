...
function page() {
  return (
    <div className="flex justify-between mt-7 pl-10">
      <div className="flex flex-col align-baseline gap-7">
        <Image
          src="/introduce_logo.svg"
          width={182}
          height={27}
          alt="요미디자인은?"
        />
        <pre className={`leading-6 ${myFont.className}`}>
          {content}
        </pre>
